...
//`define	VGA_1280_768_60FPS_79_5MHz
...
//---------------------------------
//	1280 * 768
`ifdef	VGA_1280_768_60FPS_79_5MHz
`define	H_FRONT	11'd64
`define	H_SYNC 	11'd128
`define	H_BACK 	11'd192
`define	H_DISP	11'd1280
`define	H_TOTAL	11'd1664
 					
`define	V_FRONT	11'd3
`define	V_SYNC 	11'd7  
`define	V_BACK 	11'd12 
`define	V_DISP 	11'd758  
`define	V_TOTAL	11'd790
`endif
